          ...
          <div className="space-y-6 font-body text-sm text-floral-slate leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc ml-5 space-y-1 text-xs">
                ...
                <li><span className="text-navy font-medium">Guest uploads (only if a guest chooses to):</span> Polaroid-stamped photo (JPEG), optional 280-character note, optional display name, phase, wedding slug, timestamp. No audio is collected.</li>
